...
export function ControlCenterSidebar() {
  ...
  const { navigation } = useControlCenterContext();
      ...
      >
        <div className="flex h-14 items-center justify-between px-3">
          ...
          >
            ...
            {!isCollapsed ? <span className="truncate">Control Center</span> : null}
          </div>
          {isMobile ? (
        ...
        <ScrollArea className="flex-1 px-2 py-4">
          <nav className="space-y-4" aria-label="Control center navigation">
...
export function ControlCenterSidebarTrigger() {
